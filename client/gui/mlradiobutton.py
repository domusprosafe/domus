...
class MLRadioButton(wx.RadioButton):

        def __init__(self, parent, id=-1, label=wx.EmptyString, wrap=-1, pos=wx.DefaultPosition, size=wx.DefaultSize, style=0, validator=wx.DefaultValidator, name=wx.RadioButtonNameStr):
